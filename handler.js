...
export async function handler(chatUpdate) {
    ...
    try {
        ...
        // INICIO: LÓGICA DE USUARIOS Y BASE DE DATOS
        try {
...
`
        ...
        // FIN: LÓGICA DE USUARIOS Y BASE DE DATOS
        ...
        const userParticipant = participants.find(p => p.id === senderLid || p.id === senderJid) || {}
        ...
        for (let name in global.plugins) {
            ...
            if (typeof plugin.before === 'function') {
                if (await plugin.before.call(this, m, { match, conn: this, participants, groupMetadata, user: userParticipant, bot: botParticipant, isROwner, isOwner, isRAdmin, isAdmin, isBotAdmin, isPrems, chatUpdate, __dirname: ___dirname, __filename })) continue
            }
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (chat?.isBanned && !isROwner) {
                    if (!['grupo-unbanchat.js'].includes(name)) return
                }
